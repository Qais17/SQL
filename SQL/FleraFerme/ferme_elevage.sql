...
CREATE TABLE `elevage` (
  ...
  `capacite` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idElevage`),
  CONSTRAINT `fkanimalElevage` FOREIGN KEY (`idElevage`) REFERENCES `animal` (`idanimal`),
  CONSTRAINT `fkterrainElevage` FOREIGN KEY (`idElevage`) REFERENCES `terrain` (`idterrain`)
...
-- Dump completed on 2018-11-19 14:17:22
